...
class GUI_Main:
    ...
    def show_main_menu(self, render):
        ...
        # 4d686d
        start_game_button = tkinter.Button(master=bottom, text="START GAME", font=("Helvetica", 20, BOLD), height=2,
                                           width=18, bg="#39494c", fg="white")
        start_game_button.pack()

        scoreboard_button = tkinter.Button(master=bottom, text="SCOREBOARD", font=("Helvetica", 20, BOLD), height=2,
                                           width=18, bg="#39494c", fg="white")
